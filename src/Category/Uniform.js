...
//THIS PAGE WILL DISPLAY THE UNIFORM PRODUCTS
...
import uniformAlt from '../Assets/webp-img/uniform-alt.webp'
...
<div className='border p-2 bg-gray-300 rounded-lg uppercase flex items-center '>
    ...
    <div>
    {/* <img className='w-36 h-36 rounded-md' src={product.productImg} alt={uniformAlt} /> */}
    <img className='w-36 h-36 rounded-md' src={tempImg} alt={uniformAlt} />
    </div>
